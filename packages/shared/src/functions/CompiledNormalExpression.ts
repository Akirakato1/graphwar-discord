...
import { normalizeFunctionHitExpression } from "../lobby/gameplaySettings";
...
function assertAdvancedFunctionsAllowed(expressionText: string, options: CompileNormalExpressionOptions): void {
